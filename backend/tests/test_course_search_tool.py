...
class TestCourseSearchTool:
    ...
    def test_execute_successful_search(self):
        ...
        with patch.object(self.tool, '_get_lesson_link', return_value="http://example.com/lesson1"):
    ...
    def test_execute_with_lesson_filter(self):
        ...
        with patch.object(self.tool, '_get_lesson_link', return_value="http://example.com/lesson3"):
    ...
    def test_execute_no_course_filter_message(self):
        ...
        result = self.tool.execute("test query", course_name="Missing Course", lesson_number=5)
    ...
    def test_format_results_multiple_documents(self):
        ...
        with patch.object(self.tool, '_get_lesson_link', side_effect=[
    ...
    def test_get_lesson_link_success(self):
        ...
        self.mock_vector_store.course_catalog.get.assert_called_once_with(ids=["Test Course"])
    ...
    def test_get_lesson_link_not_found(self):
        ...
        link = self.tool._get_lesson_link("Test Course", 1)  # Looking for lesson 1, but only lesson 2 exists
    ...
    def test_last_sources_tracking(self):
        ...
        with patch.object(self.tool, '_get_lesson_link', return_value="http://example.com/test"):
