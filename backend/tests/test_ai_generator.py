...
class TestAIGenerator:
    ...
    def test_initialization_with_placeholder_api_key(self):
        ...
        generator = AIGenerator("your-anthropic-api-key-here", "claude-sonnet-4-20250514")
        assert generator.use_mock == True
        assert not hasattr(generator, 'client')
    ...
    def test_generate_response_without_api_key_uses_mock(self):
        ...
        assert result == "API key not configured. Please set your Anthropic API key to use this service."
    ...
    def test_multi_round_tool_calling_two_rounds(self, mock_anthropic):
        ...
        mock_tool_manager.execute_tool.assert_any_call("get_course_outline", course_id="course-x")
        mock_tool_manager.execute_tool.assert_any_call("search_course_content", query="authentication")
